...
## <span style="color:#00994C"> 게임 규칙 </span>
...
## <span style="color:#00994C"> 종족 </span>
...
## <span style="color:#00994C"> 게임 실행 </span>
1. 게임이 실행되면 사용자는 3가지 종족 중 하나를 선택할 수 있습니다.

   - Terran 을 선택하면 5개의 유닛이 무작위로 생성됩니다.

   - Protos 를 선택하면 4개의 유닛이 무작위로 생성됩니다.
